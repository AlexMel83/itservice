    ...
    <div class="mx-auto flex size-full max-w-full items-center justify-between">
      ...
      >
        <div class="flex flex-col items-center lg:flex-row">
          ...
          >
          <div
            @mouseenter="openOnDesktopDropdownMenu"
            @mouseleave="closeOnDesktopDropdownMenu"
            class="relative"
          >
            <button
              ...
              >
                <div class="flex w-full flex-col lg:flex-row">
                  ...
                  >
                    ...
                    >
                      <h4
                        class="text-sm font-semibold leading-[1.4] md:leading-[1.3]"
                      >
                        Our Services
                      </h4>
                      <a
                      ...
                      >
                        ...
                        <div class="flex flex-col items-start justify-center">
                          ...
                          <p class="hidden text-sm md:block">
                            Experience your space like never before.
                          </p>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <div class="flex flex-col items-start justify-center">
                          ...
                          <p class="hidden text-sm md:block">
                            Reliable support for your business technology.
                          </p>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <div class="flex flex-col items-start justify-center">
                          ...
                          <p class="hidden text-sm md:block">
                            Protect your assets with our solutions.
                          </p>
                        </div>
                      </a>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="flex flex-col items-start justify-center">
                          ...
                          <p class="hidden text-sm md:block">
                            Special offers for those who served.
                          </p>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <div class="flex flex-col items-start justify-center">
                          ...
                          <p class="hidden text-sm md:block">
                            Helping those in need with IT services.
                          </p>
                        </div>
                      </a>
                      <a
                  ...
                  <div
                    class="flex w-full items-center justify-center self-start py-4 lg:size-auto lg:py-8 lg:px-8"
                  >
                    <button
        ...
        <button
          class="bg-primary-500 text-white font-bold py-2 px-4 rounded hidden lg:block"
        >
          Request a Quote
        </button>
      </div>
